...
// Menggunakan aiService yang baru (otomatis switch mock/real)
import { 
  analyzeImage, 
  validateImage, 
  createImagePreview, 
    ...
    >
      ...
      <div className="relative mb-6">
        ...
        <div className={`relative w-16 h-16 rounded-xl shadow-lg flex items-center justify-center text-primary border transition-all duration-300
          ${isDragging 
            ? 'bg-blue-100 border-primary scale-110' 
      ...
      <div className="group relative w-full">
        ...
        <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-blue-100">
          ...
          {currentState === STATES.IDLE && (
            <div className="bg-blue-50/50 border-t border-blue-100 px-6 py-4 flex flex-wrap justify-between items-center gap-4 text-xs font-medium text-slate-600 uppercase tracking-wide">
