  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white min-h-screen flex flex-col font-display overflow-x-hidden selection:bg-primary selection:text-white">
      ...
      <main className="flex-grow">
        ...
        <section ref={heroRef} className="relative py-20 sm:py-28 overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
            ...
            <h1 className="hero-title text-4xl sm:text-5xl md:text-6xl font-black tracking-tight mb-6">
              ...
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-indigo-500 to-purple-500 ai-text-glow">
                Image Misinformation
              </span>
            </h1>
            
            <p className="hero-subtitle max-w-2xl mx-auto text-lg sm:text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="what-is-content">
                ...
                <div className="space-y-4 text-slate-600 dark:text-slate-400">
                  <p className="text-lg leading-relaxed">
                    DeepVerify is an <strong className="text-slate-900 dark:text-white">AI-powered image classification platform</strong> that analyzes images to determine whether they are authentic photographs or generated by artificial intelligence.
                  </p>
                  ...
                  <p className="leading-relaxed">
                    Our mission is to <strong className="text-slate-900 dark:text-white">reduce misinformation</strong>, combat deepfakes, and promote <strong className="text-slate-900 dark:text-white">digital authenticity</strong> in an era where AI-generated content is becoming increasingly sophisticated.
                  </p>
                </div>
              </div>
              ...
              <div className="what-is-image relative">
                <div className="relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="aspect-square rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 flex flex-col items-center justify-center p-4 border border-emerald-500/30">
                      ...
                      <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400">Real Photo</span>
                    </div>
                    <div className="aspect-square rounded-xl bg-gradient-to-br from-red-500/20 to-red-600/10 flex flex-col items-center justify-center p-4 border border-red-500/30">
                      ...
                      <span className="text-sm font-bold text-red-600 dark:text-red-400">AI Generated</span>
                    </div>
                  </div>
        ...
        <section ref={whyMattersRef} className="py-16 sm:py-24 bg-slate-50/50 dark:bg-slate-900/30">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {whyMattersCards.map((card, index) => (
                <div 
                  key={index}
                  className={`why-card group bg-white dark:bg-slate-800/50 rounded-xl p-6 border border-slate-200 dark:border-slate-700/50 hover:border-${card.color}-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-${card.color}-500/10`}
                >
              ...
              <div className="space-y-8">
                {technologySteps.map((step, index) => (
                  <div key={index} className="tech-step relative flex gap-6 items-start">
                    ...
                    {/* Content */}
                    <div className="flex-grow bg-white dark:bg-slate-800/50 rounded-xl p-6 border border-slate-200 dark:border-slate-700/50">
        ...
        {/* CTA Section */}
        <section ref={ctaRef} className="py-16 sm:py-24 bg-gradient-to-br from-primary/5 via-indigo-500/5 to-purple-500/5">
          <div className="max-w-3xl mx-auto px-4 text-center cta-content">
            <div className="bg-white dark:bg-slate-800/80 rounded-2xl p-8 sm:p-12 border border-slate-200 dark:border-slate-700 shadow-xl">
